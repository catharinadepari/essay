...
With this understanding, the storymap entitled **`America's Public Land Giveaway`** written by *Andre Miller* is selected for this essay. The storymap provides a good example of how the author carefully designed and selected web features to convince public on the implications of the U.S. government's unreformed land leasing system and regulation in the Western part of this country and to mobilize civic power for land regulation reformation and natural heritage conservation.<br>
